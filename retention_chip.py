...
parser.add_argument("--ret-reads", type=int, default=1, help="how many retention reads to do")
...
parser.add_argument("--read-only", action="store_true", help="do reads only")
