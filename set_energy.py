...
# Get arguments
parser = argparse.ArgumentParser(description="Measure SET energy on a chip.")
...
with EMBERDriver(args.chipname, args.config) as ember:
  ...
  ember.settings["pw_rst_cycle_exp"] = 0
  ember.settings["pw_rst_cycle_mantissa"] = 0
  ember.settings["wl_dac_rst_lvl_cycle"] = 0
  ember.settings["sl_dac_rst_lvl_cycle"] = 0
